...
public final class DynamicConstants
{
   ...
   */
  public static String PRODUCT_NAME = "OpenDJ";

  /**
   * The short product name for the Directory Server.
   */
  public static String SHORT_NAME = "OpenDJ";
   ...
   */
  public static int POINT_VERSION = 4;
   ...
   */
  public static String BUILD_ID = "20120307182812Z";

  /**
   * The username of the user that created this build.
   */
  public static String BUILD_USER = "edavmax";

  /**
   * The Java version used to generate this build.
   */
  public static String BUILD_JAVA_VERSION = "1.6.0_30";

  /**
   * The vendor for the Java version used to generate this build.
   */
  public static String BUILD_JAVA_VENDOR = "Sun Microsystems Inc.";

  /**
   * The JVM version used to generate this build.
   */
  public static String BUILD_JVM_VERSION = "20.5-b03";

  /**
   * The vendor for the JVM used to generate this build.
   */
  public static String BUILD_JVM_VENDOR = "Sun Microsystems Inc.";

  /**
   * The operating system on which this build was generated.
   */
  public static String BUILD_OS = "Linux 2.6.32-131.0.15.el6.x86_64 amd64";
   ...
   */
  public static long REVISION_NUMBER = -1;
  ...
  public static String DOC_QUICK_REFERENCE_GUIDE =
      "http://opendj.forgerock.org/doc/admin-guide/OpenDJ-Admin-Guide.html";
