...
public interface PasswordPolicyCfg extends Configuration {
   ...
   */
  void addChangeListener(ConfigurationChangeListener<PasswordPolicyCfg> listener);
   ...
   *          The Password Policy configuration change listener.
   */
  void removeChangeListener(ConfigurationChangeListener<PasswordPolicyCfg> listener);
