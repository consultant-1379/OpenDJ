...
import org.opends.server.admin.std.client.ConfigFileHandlerBackendCfgClient;
...
public final class ConfigFileHandlerBackendCfgDefn extends ManagedObjectDefinition<ConfigFileHandlerBackendCfgClient, ConfigFileHandlerBackendCfg> {
  ...
  private static final ConfigFileHandlerBackendCfgDefn INSTANCE = new ConfigFileHandlerBackendCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.ConfigFileHandler");
   ...
   * singleton.
   *
   * @return Returns the Config File Handler Backend configuration
   ...
   * Private constructor.
   */
  private ConfigFileHandlerBackendCfgDefn() {
    super("config-file-handler-backend", BackendCfgDefn.getInstance());
  }
   ...
   * {@inheritDoc}
   */
  public ConfigFileHandlerBackendCfgClient createClientConfiguration(
      ManagedObject<? extends ConfigFileHandlerBackendCfgClient> impl) {
    return new ConfigFileHandlerBackendCfgClientImpl(impl);
  }
   ...
   * {@inheritDoc}
   */
  public ConfigFileHandlerBackendCfg createServerConfiguration(
      ServerManagedObject<? extends ConfigFileHandlerBackendCfg> impl) {
    return new ConfigFileHandlerBackendCfgServerImpl(impl);
  }
   ...
   * {@inheritDoc}
   */
  public Class<ConfigFileHandlerBackendCfg> getServerConfigurationClass() {
    return ConfigFileHandlerBackendCfg.class;
  }
   ...
   */
  private static class ConfigFileHandlerBackendCfgClientImpl implements
    ConfigFileHandlerBackendCfgClient {

    // Private implementation.
    private ManagedObject<? extends ConfigFileHandlerBackendCfgClient> impl;



    // Private constructor.
    private ConfigFileHandlerBackendCfgClientImpl(
        ManagedObject<? extends ConfigFileHandlerBackendCfgClient> impl) {
      this.impl = impl;
    }
     ...
     * {@inheritDoc}
     */
    public ManagedObjectDefinition<? extends ConfigFileHandlerBackendCfgClient, ? extends ConfigFileHandlerBackendCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class ConfigFileHandlerBackendCfgServerImpl implements
    ConfigFileHandlerBackendCfg {

    // Private implementation.
    private ServerManagedObject<? extends ConfigFileHandlerBackendCfg> impl;
    ...
    // Private constructor.
    private ConfigFileHandlerBackendCfgServerImpl(ServerManagedObject<? extends ConfigFileHandlerBackendCfg> impl) {
      this.impl = impl;
     ...
     * {@inheritDoc}
     */
    public void addConfigFileHandlerChangeListener(
        ConfigurationChangeListener<ConfigFileHandlerBackendCfg> listener) {
     ...
     * {@inheritDoc}
     */
    public void removeConfigFileHandlerChangeListener(
        ConfigurationChangeListener<ConfigFileHandlerBackendCfg> listener) {
     ...
     * {@inheritDoc}
     */
    public Class<? extends ConfigFileHandlerBackendCfg> configurationClass() {
      return ConfigFileHandlerBackendCfg.class;
    }
