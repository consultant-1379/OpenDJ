...
/**
 * A client-side interface for reading and modifying Workflow Element
 * settings.
 * <p>
 * Workflow Elements implement a single processing step in a Work
 * Flow.
 */
public interface WorkflowElementCfgClient extends ConfigurationClient {

  /**
   * Get the configuration definition associated with this Workflow Element.
   *
   * @return Returns the configuration definition associated with this Workflow Element.
   */
