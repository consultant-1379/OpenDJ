 ...
 */
public interface ConfigFileHandlerBackendCfgClient extends BackendCfgClient {

  /**
   * Get the configuration definition associated with this Config File Handler Backend.
   *
   * @return Returns the configuration definition associated with this Config File Handler Backend.
   */
